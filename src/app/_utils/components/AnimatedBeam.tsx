...
export default function AnimatedBeamDemo(props: any) {
  ...
  return (
    <div
      className={`${className ? className : 'relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl'} `}
      ref={containerRef}
    >
